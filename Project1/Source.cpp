...
int main() {
    ...
    list <Rider> wait_list;//hold riders waiting to get on elevator. will be a priority queue
    // based on fifo unless someone in the middle is getting on/off at the elevator's current location
